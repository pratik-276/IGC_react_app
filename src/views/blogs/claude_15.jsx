...
const CLAUDE15 = () => {
  const metrics = [
    {
      ...
      takeaway: 'Better returns than 63% of games. Competitive RTP that appeals to value-conscious players.'
    },
    {
      title: 'Max Win',
      value: '15,000x',
      ...
      takeaway: 'Exceptional win potential that outperforms 88% of games. Attracts high-volatility seekers and jackpot hunters.'
    },
    {
      title: 'Min Bet',
      value: '$0.10',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.title}>Zeus vs Hades: Gods of War</div>
