...
const CLAUDE17 = () => {
  const metrics = [
    {
      ...
      takeaway: 'Lower returns than 62% of games. Players may seek higher RTP alternatives for better long-term value.'
    },
    {
      title: 'Max Win',
      value: '6,750x',
      percentile: 68.47,
      performance: 'GOOD - Strong Potential',
      performanceClass: 'good',
      takeaway: 'Solid win potential that outperforms 68% of games. Appeals to players seeking good volatility and excitement.'
    },
    {
      title: 'Min Bet',
      value: '$0.20',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.title}>The Dog House</div>
