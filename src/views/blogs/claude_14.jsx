...
const CLAUDE14 = () => {
  const metrics = [
    {
      ...
      takeaway: 'Lower returns than 65% of games. Players seeking value may prefer higher RTP alternatives.'
    },
    {
      title: 'Max Win',
      value: '5,000x',
      ...
      takeaway: 'Solid win potential that outperforms 58% of games. Appeals to players seeking decent volatility rewards.'
    },
    {
      title: 'Min Bet',
      value: '$0.20',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.title}>Fruit Party 2</div>
