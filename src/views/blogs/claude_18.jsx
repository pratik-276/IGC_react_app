...
const CLAUDE18 = () => {
  const metrics = [
    {
      ...
      takeaway: 'Lower returns than 63% of games. Players may seek higher RTP alternatives for better long-term value.'
    },
    {
      title: 'Max Win',
      value: '5,000x',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.title}>Gates of Hades</div>
