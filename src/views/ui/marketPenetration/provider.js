...
const MarketPenetrationProviderDashboard = () => {
    ...
    let items = [{ label: "Providers", command: () => navigate("/market-penetration-provider") }];
    ...
    const fetchTableData = async ({ reset = false } = {}) => {
        ...
        try {
            let res;
            res = await MarketPenetration.market_penetration_provider_data({
                "countries": selectedCountries ? selectedCountries : [],
                "licenses": selectedLicenses ? selectedLicenses : [],
                "operators": selectedCasinos ? selectedCasinos : [],
                limit: PAGE_SIZE,
    ...
    const columns = [
        ...
        //     header: headerWithTooltip(
        //         "Active Operators",
        //         "Overall count of operators where the provider's games are found in lobby",
        //         "active_operators",
        //     ),
        //     body: textTemplate("active_operators"),
        //     sortable: true,
        // },
        ...
        //     header: headerWithTooltip(
        //         "Visible Games",
        //         "Overall count of games visible in operator lobbies",
        //         "active_games",
        //     ),
        //     body: textTemplate("active_games"),
        //     sortable: true,
        // },

        {
            ...
            header: headerWithTooltip(
                "Coverage",
                "Coverage of this provider across all operators",
                "coverage",
            ),
...
export default MarketPenetrationProviderDashboard;
